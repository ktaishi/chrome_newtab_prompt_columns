...
const I18N_MESSAGES = {
  ja: {
    ...
    "settings.openaiPromptNote": "プレースホルダ: 共通 {{OUTPUT_LANGUAGE}} {{UI_LOCALE}}。System — 出力形式ルール。User — {{DOCUMENT}} {{INQUIRY}} {{URL_CONTEXTS}}。組み込みデフォルトは js/services/openai-prompt-defaults.js。デフォルトと同じ内容を保存すると storage は空になり、次回更新で新デフォルトが反映されます。",
    ...
    "modal.aiChatOpen": "AIに問い合わせ",
    "modal.aiChatTitle": "AI問い合わせ",
    ...
    "openai.action.summary": "現在のドキュメントを読みやすく整理してください。",
    "openai.action.deepDive": "現在のドキュメントについて、背景や詳細を深掘りして説明してください。",
    "openai.action.simpleList": "現在のドキュメントの要点だけを箇条書きにしてください。",
    "openai.action.tryIt": "現在のドキュメントを踏まえ、試せる具体的なステップやチェックリストを提案してください。",
    ...
    "openai.noContent": "問い合わせ対象のドキュメントがありません。",
    "openai.noInquiry": "問い合わせ文を入力してください。",
  ...
  en: {
    ...
    "settings.openaiPromptNote": "Placeholders: shared {{OUTPUT_LANGUAGE}} {{UI_LOCALE}}. System — output format rules. User — {{DOCUMENT}} {{INQUIRY}} {{URL_CONTEXTS}}. Bundled defaults live in js/services/openai-prompt-defaults.js. Saving the built-in default clears storage so future updates pick up new defaults.",
    ...
    "modal.aiChatOpen": "Ask AI",
    "modal.aiChatTitle": "AI inquiry",
    "modal.updated": "Updated: {datetime}",
    ...
    "openai.action.summary": "Organize the current document clearly.",
    "openai.action.deepDive": "Explain the current document in more depth, including background and details.",
    "openai.action.simpleList": "List only the key points of the current document as bullets.",
    "openai.action.tryIt": "Based on the current document, suggest concrete steps or a checklist the reader can try.",
    ...
    "openai.noContent": "No document to send.",
    "openai.noInquiry": "Enter an inquiry message.",
