...
const modalAiChatOverlay = document.querySelector("#modalAiChatOverlay");
const modalAiChatTrigger = document.querySelector("#modalAiChatTrigger");
const modalAiChatOpenButton = document.querySelector("#modalAiChatOpenButton");
const modalAiChatCloseButton = document.querySelector("#modalAiChatCloseButton");
const modalAiChatCancelButton = document.querySelector("#modalAiChatCancelButton");
